...
type Request struct {
	...
	Numbers []int64 `protobuf:"varint,1,rep,packed,name=numbers,proto3" json:"numbers,omitempty"` // int64 limit = 2;
}
...
func (x *Request) GetNumbers() []int64 {
	if x != nil {
		return x.Numbers
	}
	return nil
...
var file_proto_proto_proto_rawDesc = []byte{
	...
	0x62, 0x65, 0x72, 0x32, 0x32, 0x0a, 0x04, 0x4d, 0x61, 0x74, 0x68, 0x12, 0x2a, 0x0a, 0x03, 0x4d,
	0x61, 0x78, 0x12, 0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x0b, 0x5a, 0x09, 0x61, 0x70, 0x70, 0x2f, 0x70,
...
var file_proto_proto_proto_depIdxs = []int32{
	0, // 0: proto.Math.Max:input_type -> proto.Request
	1, // 1: proto.Math.Max:output_type -> proto.Response
