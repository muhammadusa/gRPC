...
type MathClient interface {
	Max(ctx context.Context, in *Request, opts ...grpc.CallOption) (Math_MaxClient, error)
}
...
func (c *mathClient) Max(ctx context.Context, in *Request, opts ...grpc.CallOption) (Math_MaxClient, error) {
	stream, err := c.cc.NewStream(ctx, &Math_ServiceDesc.Streams[0], "/proto.Math/Max", opts...)
	if err != nil {
		return nil, err
	}
...
type MathServer interface {
	Max(*Request, Math_MaxServer) error
...
func (UnimplementedMathServer) Max(*Request, Math_MaxServer) error {
...
func _Math_Max_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(MathServer).Max(m, &mathMaxServer{stream})
}
